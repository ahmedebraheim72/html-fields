...
```html
    {{-- styles --}}
    <link href="{{asset('HtmlFields/plugins/ck-editor-5/css/ckeditor.css')}}" rel="stylesheet" id="style_components" type="text/css" />

    {{-- scripts --}}
    <script src="{{asset('HtmlFields/plugins/ck-editor-5/js/ckeditor.js')}}"></script>
    <script src="{{asset('HtmlFields/plugins/ck-editor-5/js/ckEditorScripts.js')}}"></script>
```
