...
if (!function_exists('HtmlFieldsGetTagConfig')) {

    function HtmlFieldsGetTagConfig($type, $config)
    {
...
if (!function_exists('HtmlFieldsOptionsToStr')) {

    function HtmlFieldsOptionsToStr($options)
    {
        $response = '';
